...
public final class MessengerGrpc {
  ...
  public static final String SERVICE_NAME = "network.p2p.Messenger";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<network.p2p.Message,
      com.google.protobuf.Empty> getDeliverMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Deliver",
      requestType = network.p2p.Message.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<network.p2p.Message,
      com.google.protobuf.Empty> getDeliverMethod() {
    io.grpc.MethodDescriptor<network.p2p.Message, com.google.protobuf.Empty> getDeliverMethod;
      ...
      synchronized (MessengerGrpc.class) {
        if ((getDeliverMethod = MessengerGrpc.getDeliverMethod) == null) {
          MessengerGrpc.getDeliverMethod = getDeliverMethod =
              io.grpc.MethodDescriptor.<network.p2p.Message, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Deliver"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  network.p2p.Message.getDefaultInstance()))
  ...
  public static abstract class MessengerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<network.p2p.Message> deliver(
  ...
  private static abstract class MessengerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return network.p2p.MessageOuterClass.getDescriptor();
    }
