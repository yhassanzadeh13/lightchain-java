...
public class LcAssignerTest {
  ...
  public void testAssignerFails_NotEnoughAccount() throws IllegalArgumentException {
    ...
    try {
      ...
      Assertions.assertEquals(Assigner.NOT_ENOUGH_ACCOUNTS, e.getMessage());
    }
  }
  ...
  public void testAssignerFails_NullIdentifier() throws IllegalArgumentException {
    ...
    try {
      ...
      Assertions.assertEquals(Assigner.IDENTIFIER_CANNOT_BE_NULL, e.getMessage());
    }
  ...
  public void testAssignerFails_NullSnapshot() throws IllegalArgumentException {
    ...
    try {
      ...
      Assertions.assertEquals(Assigner.SNAPSHOT_CANNOT_BE_NULL, e.getMessage());
    }
