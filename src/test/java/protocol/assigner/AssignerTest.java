...
public class AssignerTest {
  ...
  // For all tests consider a snapshot of 10 staked accounts and 10 unstaked accounts as well as a mock identifier (for assigner parameter).
  ...
  // 2. num = 5 should pick five of the staked accounts, also, running the test 100 times always picks the same accounts.
